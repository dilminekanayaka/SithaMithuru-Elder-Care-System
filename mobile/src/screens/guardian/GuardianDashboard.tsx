...
const GuardianDashboard: React.FC<GuardianDashboardProps> = ({ onLogout, userName = 'Mr. Dumidu', onNavigate }: GuardianDashboardProps) => {
    const [activeTab, setActiveTab] = useState('home');

    const activityList = [
        { id: 1, type: 'med', title: 'Took Morning medicine dose', time: '2 hours ago', icon: 'pill' },
        { id: 2, type: 'mood', title: 'Feeling Happy Today', time: '4 hours ago', icon: 'emoticon-happy-outline' },
        { id: 3, type: 'med', title: 'Missed Dinner medicine dose', time: 'yesterday', icon: 'pill' },
        { id: 4, type: 'med', title: 'Took Lunch medicine dose', time: 'yesterday', icon: 'pill' },
    ];
        ...
        <SafeAreaView style={styles.container}>
                ...
                <View style={styles.grid}>
                    ...
                    <View style={[styles.card, { borderColor: '#2ECC71' }]}>
                        <View style={[styles.cardIconBox, { backgroundColor: '#E8F8F0' }]}>
                            <MaterialCommunityIcons name="account-outline" size={24} color="#2ECC71" />
                        </View>
                    ...
                    <View style={[styles.card, { borderColor: '#9B59B6' }]}>
                        <View style={[styles.cardIconBox, { backgroundColor: '#F4ECF7' }]}>
                            <MaterialCommunityIcons name="checkbox-marked-outline" size={24} color="#9B59B6" />
                        </View>
                    ...
                    <View style={[styles.card, { borderColor: '#F1C40F' }]}>
                        <View style={[styles.cardIconBox, { backgroundColor: '#FEF9E7' }]}>
                            <MaterialCommunityIcons name="emoticon-dead-outline" size={24} color="#F1C40F" />
                        </View>
                    ...
                    {activityList.map((item) => (
                        <View key={item.id} style={styles.activityItem}>
                            <View style={styles.activityIconContainer}>
                                <MaterialCommunityIcons name={item.icon} size={20} color="#3F51B5" />
                            </View>
            ...
            <View style={styles.bottomNav}>
                ...
                <TouchableOpacity style={styles.navItem} onPress={() => onNavigate('manageElder')}>
                    <MaterialCommunityIcons name="account-cog-outline" size={28} color="#95A5A6" />
                </TouchableOpacity>
                <TouchableOpacity style={styles.navItem}>
